...
class GoalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('frontend/goal/index.html.twig', array(
            'goals' => $goals,
            'imps' => $imps,
            'todos' => $todos,
        ));
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('frontend/goal/new.html.twig', array(
            'goal' => $goal,
    ...
    public function showAction(Goal $goal)
    {
        ...
        return $this->render('frontend/goal/show.html.twig', array(
            'goal' => $goal,
    ...
    public function editAction(Request $request, Goal $goal)
    {
        ...
        return $this->render('frontend/goal/edit.html.twig', array(
            'goal' => $goal,
